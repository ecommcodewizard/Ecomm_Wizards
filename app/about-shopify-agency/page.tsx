            ...
            const rows: { logos: { src: string; alt: string }[]; direction: "left" | "right"; duration: number }[] = [
              {
                logos: [
                  ...
                  { src: "/images/Case%20studies/logos/Happy-Mammoth.png", alt: "" },
                ],
                direction: "left",
                duration: 40,
              },
              {
                logos: [
                  { src: "/images/Case%20studies/logos/Saddleback.svg", alt: "" },
                  { src: "/images/Case%20studies/logos/Twillory.png", alt: "" },
                  { src: "/images/Case%20studies/logos/Dryrobe.svg", alt: "" },
                  { src: "/images/Case%20studies/logos/John_Hardy.svg", alt: "" },
                  { src: "/images/Case%20studies/logos/Loop_Earplugs.svg", alt: "" },
                  { src: "/images/Case%20studies/logos/ChloBo.svg", alt: "" },
                ],
                direction: "right",
                duration: 42,
              },
              {
                logos: [
                  { src: "/images/Case%20studies/logos/SNEAK%20Energy.svg", alt: "" },
                  { src: "/images/Case%20studies/logos/this-works-logo.png", alt: "" },
                  { src: "/images/Case%20studies/logos/Capelli-Sport-Plus-Logo.webp", alt: "" },
                  { src: "/images/Case%20studies/logos/feetures.svg", alt: "" },
