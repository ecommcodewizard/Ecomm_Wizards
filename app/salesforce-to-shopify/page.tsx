...
export const metadata: Metadata = {
  title: "Salesforce to Shopify Migration | Ecomm Wizards",
  description:
    "We move enterprise stores off Salesforce Commerce Cloud onto Shopify Plus. Same catalog, same customers, lower TCO. Real owner, real engineers, real launch dates.",
};
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              Move your store off Salesforce Commerce Cloud. Land on Shopify Plus on time.
            </h1>
          ...
          <div className="w2s-hero-visual">
            ...
            <img
              ...
              alt="Salesforce Commerce Cloud storefront migrating to Shopify Plus analytics dashboard"
              width={1024}
              height={1024}
              loading="eager"
            />
          ...
          <div className="shy-why-grid">
            <div className="shy-why-visual">
              ...
              <div className="shy-why-badge" aria-label="Ecomm Wizards, Shopify Plus Experts">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/images/ecomm-green-logo-cropped.png" alt="Ecomm Wizards" />
