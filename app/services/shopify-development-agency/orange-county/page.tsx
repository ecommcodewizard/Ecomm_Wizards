...
import { SHOPIFY_DEV_ORANGE_COUNTY as page } from "@/lib/geo/pages/shopify-development-agency-orange-county";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme page 9 (Batch 1). Content lives in
// lib/geo/pages/shopify-development-agency-orange-county.ts; this route wires
