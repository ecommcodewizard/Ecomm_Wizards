...
const META_DESCRIPTION =
  "WooCommerce to Shopify migration without downtime. We move your products, customers, orders, and SEO with zero data loss. Get a free test drive.";
const CANONICAL_URL = "https://ecommwizards.com/services/migration/woocommerce-to-shopify";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "WooCommerce to Shopify Migration Agency | Zero Downtime",
    description: META_DESCRIPTION,
    images: [
      {
        url: "/images/woocommerce-hero-scaled.webp",
        alt: "WooCommerce to Shopify migration by Ecomm Wizards",
      },
    ],
  },
  twitter: {
    ...
    title: "WooCommerce to Shopify Migration Agency | Zero Downtime",
    description: META_DESCRIPTION,
    images: ["/images/woocommerce-hero-scaled.webp"],
  },
};
...
const FAQS = [
  {
    q: "Will I lose my SEO rankings when I migrate from WooCommerce to Shopify?",
    a: "No. We map every WooCommerce URL, set up 301 redirects, and carry over your metadata, structured data, and content. Google sees a clean handoff, so your rankings and organic traffic hold steady through the move.",
  },
  {
    q: "How long does a WooCommerce to Shopify migration take?",
    a: "Most WooCommerce migrations run two to six weeks depending on catalog size, custom functionality, and the plugins you rely on. We scope the exact timeline on your discovery call and hand you a clear plan before any work starts.",
  },
  {
    q: "Will my WooCommerce store go down during the migration?",
    a: "No. We build and test your Shopify store in parallel while your WooCommerce store keeps selling. We only point the domain over once everything checks out, so your customers never hit a dead site.",
  },
  {
    q: "What data transfers from WooCommerce to Shopify?",
    a: "Products and variants, customers, full order history, blog posts and pages, reviews, coupons, and SEO assets. Anything that lives in your WooCommerce store gets mapped to Shopify so nothing breaks and nothing duplicates.",
  },
  {
    q: "How much does a WooCommerce to Shopify migration cost?",
  ...
  {
    q: "What happens to my WooCommerce plugins and integrations?",
    a: "We audit every plugin and integration you depend on, from payments and shipping to email, reviews, and subscriptions, then rebuild or replace each one with a Shopify app so your operations keep running the day you launch.",
  },
  {
    q: "Do you migrate to Shopify or Shopify Plus?",
    a: "Both. We help you pick the right plan for your order volume, then handle the full build. If you are outgrowing WooCommerce and scaling fast, our Shopify Plus team sets you up for high-traffic sales and B2B from day one.",
  },
];
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "WooCommerce to Shopify", item: "https://ecommwizards.com/services/migration/woocommerce-to-shopify" },
  ],
};
...
export default function Page() {
  return (
    <>
      ...
      />
      <ServiceSchema url={CANONICAL_URL} name="WooCommerce to Shopify Migration" serviceType="WooCommerce to Shopify migration" description={META_DESCRIPTION} />
      <Breadcrumbs current="/services/migration/woocommerce-to-shopify" />
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              Ready to migrate from <span style={GRADIENT_TEXT}>WooCommerce to Shopify</span>? We&rsquo;ll handle the messy parts.
            </h1>
        ...
        <div className="w2s-data-inner">
          <div className="w2s-data-visual">
            ...
            <img
              ...
              alt="Reviewing WooCommerce to Shopify migration data on a tablet"
              loading="lazy"
            />
          </div>
      ...
      {/* FAQ — WooCommerce to Shopify migration objections */}
      <section className="w2s-faq">
        <div className="w2s-faq-inner">
          <h2 className="w2s-faq-h2">WooCommerce to Shopify Migration FAQs</h2>
      ...
      <RelatedServices current="/services/migration/woocommerce-to-shopify" />
    </>
  );
}
