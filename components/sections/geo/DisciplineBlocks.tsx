    ...
    <section id="disciplines" className="gp-section gpd" style={{ scrollMarginTop: 90 }}>
            ...
            return (
              <article key={item.label} className="gpd-row" data-flip={i % 2 === 1 ? "1" : undefined}>
                <div className="gpd-copy">
                  ...
                  <div className="gpd-body"><Prose text={item.body} /></div>
                ...
                {study ? (
                  <Link href={`/case-studies/${study.slug}`} className="gpd-proof" aria-label={`${study.brandName} case study`}>
                    <span className="gpd-shot">
                      <Image
                        src={study.heroImage}
                        alt={`${study.brandName} storefront we built`}
                        width={720}
                        height={540}
      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          .gpd-heading { margin: 0 0 14px; max-width: 22ch; }
          ...
          .gpd-h3 { font-size: clamp(21px, 2.2vw, 27px); line-height: 1.25; font-weight: 700; color: #0f172a; margin: 0 0 14px; }
          ...
          .gpd-img { width: 100%; height: 100%; object-fit: cover; display: block; }
