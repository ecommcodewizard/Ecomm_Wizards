...
import { SHOPIFY_THEME_CALIFORNIA as page } from "@/lib/geo/pages/shopify-theme-development-california";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme California #9 (Batch 1b), a state page under the theme hub. Content lives in
// lib/geo/pages/shopify-theme-development-california.ts; this route wires
