...
import { ECOMMERCE_AGENCY_BOSTON as page } from "@/lib/geo/pages/ecommerce-agency-boston";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme Boston #23 (Batch 1b), a metro page on the ecommerce-agency
// hub. Content lives in lib/geo/pages/ecommerce-agency-boston.ts; this route
// wires metadata and the template only. Draft pages 404 in production and
// render on previews and locally.
