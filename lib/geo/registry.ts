...
import { ECOMMERCE_AGENCY_LOS_ANGELES } from "./pages/ecommerce-agency-los-angeles";
...
import { SHOPIFY_DEV_AUSTIN } from "./pages/shopify-development-agency-austin";
...
import { SHOPIFY_THEME_CALIFORNIA } from "./pages/shopify-theme-development-california";
import { SHOPIFY_DEV_BOSTON } from "./pages/shopify-development-agency-boston";
import { ECOMMERCE_AGENCY_BOSTON } from "./pages/ecommerce-agency-boston";
...
export const GEO_PAGES: GeoProgrammePage[] = [ECOMMERCE_AGENCY, ECOMMERCE_SEO_AGENCY, ECOMMERCE_MARKETING_AGENCY, SHOPIFY_DEV_LOS_ANGELES, SHOPIFY_DEV_NEW_YORK, ECOMMERCE_AGENCY_NEW_YORK, SHOPIFY_SEO_NEW_YORK, ECOMMERCE_AGENCY_LOS_ANGELES, ECOMMERCE_MARKETING_AGENCY_LOS_ANGELES, ECOMMERCE_AGENCY_SAN_DIEGO, SHOPIFY_DEV_SAN_DIEGO, SHOPIFY_DEV_ORANGE_COUNTY, SHOPIFY_DEV_CALIFORNIA, SHOPIFY_THEME_CALIFORNIA, ECOMMERCE_AGENCY_SAN_FRANCISCO, SHOPIFY_DEV_AUSTIN, ECOMMERCE_AGENCY_AUSTIN, ECOMMERCE_AGENCY_DALLAS, SHOPIFY_DEV_BOSTON, ECOMMERCE_AGENCY_BOSTON];
