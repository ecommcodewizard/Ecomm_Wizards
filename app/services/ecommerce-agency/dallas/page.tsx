...
import { ECOMMERCE_AGENCY_DALLAS as page } from "@/lib/geo/pages/ecommerce-agency-dallas";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme page 10 (Batch 1b, Texas block). Content lives in
// lib/geo/pages/ecommerce-agency-dallas.ts; this route wires metadata
