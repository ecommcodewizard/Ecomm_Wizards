...
export const metadata: Metadata = {
  title: "Connect Amazon to Shopify and Scale Your Amazon Brand to Shopify DTC | Ecomm Wizards",
  description:
    "We connect amazon to shopify, sync your catalog and orders, and help you scale your amazon brand into a real shopify DTC business. You keep Amazon running. We build the DTC side. Risk free test drive on the house.",
};
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              You found the team that&rsquo;ll connect amazon to shopify for you and finally hand you the customer data Amazon kept.
            </h1>
          ...
          <div className="w2s-hero-visual">
            ...
            <img
              ...
              alt="Amazon brand connecting to Shopify DTC analytics dashboard"
              width={1024}
              height={1024}
              loading="eager"
            />
