...
import { ECOMMERCE_AGENCY_LOS_ANGELES as page } from "@/lib/geo/pages/ecommerce-agency-los-angeles";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme, Batch 1 page 2. Content lives in
// lib/geo/pages/ecommerce-agency-los-angeles.ts; this route wires metadata and
// the template only. Draft pages 404 in production and render on previews and
// locally.
