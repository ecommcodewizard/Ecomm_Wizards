...
const CASE_STUDY_SLIDES: CaseStudySlide[] = [
  ...
  },
  {
    ...
    alt: "Everlast Shopify Plus store rebuilt by Ecomm Wizards",
    ...
    quote: (<>&ldquo;We needed a store that could handle the complexity of the brand: serious athletes, casual fitness buyers, and trade accounts, all in one place. Ecomm Wizards built exactly that. The <strong>conversion numbers and the trade portal revenue</strong> both exceeded what we projected.&rdquo;</>),
