...
import { ECOMMERCE_SEO_AGENCY as page } from "@/lib/geo/pages/ecommerce-seo-agency";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme hub H2 (Batch 1, page 2). Content lives in
// lib/geo/pages/ecommerce-seo-agency.ts; this route only wires metadata and the
// template. Draft pages 404 in production and render on previews and locally.
