...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Salesforce to Shopify Migration Agency | Lower Your TCO",
    description: META_DESCRIPTION,
    images: [
      {
        url: "/images/salesforce-hero.webp",
        alt: "Salesforce to Shopify migration by Ecomm Wizards",
      },
    ],
  },
  twitter: {
    ...
    title: "Salesforce to Shopify Migration Agency | Lower Your TCO",
    description: META_DESCRIPTION,
    images: ["/images/salesforce-hero.webp"],
  },
};
...
const FAQS = [
  {
    q: "Will I lose my SEO rankings when I migrate from Salesforce to Shopify?",
    a: "No. We map every Salesforce Commerce Cloud URL, set up 301 redirects, and carry over your metadata, structured data, and content. Google sees a clean handoff, so your rankings and organic traffic hold steady through the move.",
  },
  {
    q: "How long does a Salesforce to Shopify migration take?",
    a: "Most Salesforce Commerce Cloud migrations run sixty to ninety days depending on catalog size, custom cartridges, and the integrations you rely on. We scope the exact timeline on your discovery call and hand you a clear plan before any work starts.",
  },
  {
    q: "Will my Salesforce store go down during the migration?",
    a: "No. We build and test your Shopify Plus store in parallel while your Salesforce store keeps selling. We only point the domain over once everything checks out, so your customers never hit a dead site.",
  },
  {
    q: "What data transfers from Salesforce Commerce Cloud to Shopify?",
    a: "Products and variants, customers, full order history, content and pages, reviews, promotions, and SEO assets. Anything that lives in your Salesforce store gets mapped to Shopify so nothing breaks and nothing duplicates.",
  },
  {
    q: "How much does a Salesforce to Shopify migration cost?",
    a: "Cost depends on your catalog size, custom functionality, and the integrations you need rebuilt. We quote fixed prices with no hourly surprises, and most brands cut their total cost of ownership once they leave Salesforce licensing behind. Book a call for a detailed breakdown.",
  },
  {
    q: "What happens to my Salesforce cartridges and integrations?",
    a: "We audit every cartridge and integration you depend on, from ERP and OMS to payments, email, and search, then rebuild or replace each one on Shopify so your operations keep running the day you launch.",
  },
  {
    q: "Do you migrate to Shopify or Shopify Plus?",
    a: "Enterprise Salesforce brands almost always land on Shopify Plus. We help you confirm the right plan, then handle the full build so you get high-traffic checkout, B2B, and lower total cost of ownership from day one.",
  },
];
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Salesforce to Shopify", item: "https://ecommwizards.com/services/migration/salesforce-to-shopify" },
  ],
};
...
const CUSTOMIZER_SLIDES: CustomizerSlide[] = [
  {
    ...
    caption: "Cart drawers your merchandiser builds, not your dev team.",
  },
  {
    desktopSrc: "/images/slider-desktop-two_2048x2048.png",
    mobileSrc: "/images/slider-mobile-two_1024x1024.webp",
    caption: "Product pages composed in the admin. No ISML, no release window.",
  },
  {
    desktopSrc: "/images/slider-desktop-four_2048x2048.webp",
    mobileSrc: "/images/slider-mobile-four_1024x1024.png",
    caption: "Landing pages your team can rewrite the morning of the campaign.",
  },
];
...
const PROCESS_STEPS = [
  {
    key: "plan",
    title: "Plan",
    body: (<>First meeting we <strong>map your SFCC instance</strong>. Catalog hierarchy, OCAPI hooks, the ERP feed, your B2B price books, all of it on the wall. A senior engineer is in that room. No salesperson reading a deck back to you.</>),
  },
  {
    key: "design",
    title: "Design",
    body: (<>We design for conversion. Every component built around the <strong>actual buyer</strong> trying to check out on the new store. Mockups don&rsquo;t win in this shop. Revenue does.</>),
  },
  {
    key: "develop",
    title: "Develop",
    body: (<>Our team works <strong>in your repo</strong>, on your timeline. You see code in week one. No black box. No surprise handoff to a junior the day the contract is signed.</>),
  },
  {
    key: "deploy",
    title: "Deploy",
    body: (<>Cutover is rehearsed. We <strong>dry run the switch</strong>, hold a parallel staging environment alongside SFCC, and flip DNS only once checkout has been tested end to end. The date holds.</>),
  },
  {
    key: "ab",
    title: "AB Testing",
    body: (<>Launch isn&rsquo;t the win. The win is the <strong>next 90 days</strong>, where we test, measure, and ship the changes that actually lift revenue. Most agencies leave once the cutover is done. We don&rsquo;t.</>),
  },
];
...
const SCALABLE_FEATURES = [
  { key: "channels", title: "Multi-store on one admin. Regional brands, B2B portal, all under one roof" },
  { key: "uptime", title: "Auto-scaling that holds up on Black Friday. Same plan, same bill" },
  { key: "api", title: "Native Storefront API. No middleware tier, no SI on retainer" },
  { key: "customize", title: "A theme editor your merchandisers actually use. No ISML" },
  { key: "apps", title: "10,000+ apps in the Shopify store. Klaviyo, Recharge, Gorgias, day one" },
  { key: "support", title: "Shopify Plus support that answers in minutes. Not a ticket queue" },
  { key: "secure", title: "PCI, patches, uptime, all Shopify's problem. Never yours again" },
];
...
const HYDROGEN_WHY_ITEMS: HydrogenWhyItem[] = [
  {
    ...
    body: (<>Salesforce Commerce Cloud bills you a percentage of GMV on top of a six figure license. Shopify Plus is a flat fee, even at scale. Most clients cut platform spend by <strong>40 to 60 percent</strong> in year one of the salesforce commerce cloud to shopify migration.</>),
  },
  {
    title: "Ship in Days, Not Quarters",
    body: (<>Every change on SFCC needs a release cycle and a systems integrator on standby. On Shopify Plus your merchandising team ships campaigns from the admin. Your dev team stops being the bottleneck for every banner swap.</>),
  },
  {
    title: "The Highest-Converting Checkout on the Internet",
    body: (<>Shop Pay handles one tap conversion across every Shopify Plus store in the world. You stop maintaining a custom cart you wrote on SFCC. You stop tuning a checkout you didn&rsquo;t build.</>),
  },
  {
  ...
  },
  {
    ...
    body: (<>Shopify Plus runs your D2C catalog and a price list driven B2B portal on one platform. You stop paying separately for B2C and B2B clouds. One backend. One team. One source of truth.</>),
  },
  {
    title: "Hosting You Don't Manage",
    body: (<>No more sprint planning around platform patches. No more SI on retainer for security headers and uptime monitoring. Shopify Plus is <strong>operated, not just hosted</strong>. Black Friday becomes a non event.</>),
  },
];

const HYDROGEN_BENEFITS = [
  {
    title: "40 to 60% Lower Platform Spend",
    body: (<>Most of our SFCC clients cut total platform cost roughly in half in year one of the salesforce to shopify plus migration.</>),
  },
  {
    title: "Higher Conversion Day One",
    body: (<>Shop Pay converts <strong>1.7x higher</strong> than guest checkout, per Shopify&rsquo;s own data. Revenue per session goes up the day you cut over.</>),
  },
  {
    title: "Faster Time to Market",
    body: (<>Campaigns ship in days. No release window. No integrator quote. Your growth team owns the calendar again.</>),
  },
  {
  ...
  },
  {
    ...
    body: (<>Add a market, a currency, a B2B portal, all from the same Shopify Plus admin. No re architecting required.</>),
  },
];
...
const TRANSITION_MARQUEE_ITEMS = [
  "Salesforce to Shopify migration, end to end. We don't subcontract.",
  "30 minute call. No slides. The owner answers.",
  "Free test build of your storefront on Shopify Plus. No card, no pitch.",
];
    ...
    <>
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              <span style={GRADIENT_TEXT}>Salesforce to Shopify</span> migration, done on time.
            </h1>
            <p className="w2s-hero-lead">
              You&rsquo;re paying enterprise prices for a platform that&rsquo;s slowing your
              team down. Every campaign change is a ticket. Every feature is a quote from
              the SI. The salesforce to shopify migration is the part that scares you, I
              get it. That&rsquo;s the part we do for a living. Sixty to ninety days from
              kickoff and you&rsquo;re trading on Shopify Plus.
            </p>
            ...
            <p className="w2s-hero-risk">
              Free test build of your storefront on Shopify Plus.<br />
              See the front end. Then decide.
            </p>
          </div>

          <div className="w2s-hero-visual">
            <link rel="preload" as="image" href="/images/salesforce-hero.webp" fetchPriority="high" />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/salesforce-hero.webp"
              alt="Salesforce to Shopify migration dashboard showing products, orders, and customers"
              width={1800}
              height={1400}
              loading="eager"
              fetchPriority="high"
      ...
      <section className="shy-why">
        <div className="shy-why-inner">
          <div className="shy-why-heading">
            <p className="shy-why-eyebrow">Why Shopify Plus</p>
            <h2 className="shy-why-h2">Six reasons enterprise brands leave Salesforce Commerce Cloud.</h2>
          </div>
          <div className="shy-why-grid">
            <div className="shy-why-visual">
              ...
              <img
                ...
                alt="Shopify Plus storefront launched after a Salesforce Commerce Cloud migration"
                width={1024}
                height={1024}
                loading="lazy"
              />
      ...
      <section className="w2s-transition">
        <div className="w2s-transition-inner">
          <h2 className="w2s-transition-h2">
            The salesforce to shopify migration is hard. We&rsquo;ve done it enough to make it routine.
          </h2>
          <p className="w2s-transition-lead">
            Deciding to migrate from salesforce commerce cloud to shopify takes one meeting.
            Pulling it off takes a team that&rsquo;s already done it. Migrating from salesforce
            commerce cloud to shopify is mostly a data problem and a discipline problem. We
            solve both the same way every time. You stop chasing release schedules and
            integrator quotes. Your team gets the next quarter back.
          </p>
        ...
        <div className="w2s-guide-inner">
          <div className="w2s-guide-copy">
            <h2 className="w2s-guide-h2">
              Our SFCC migration playbook is yours, if you want it.
            </h2>
            <p className="w2s-guide-lead">
              Same document our engineering team gets on day one of a salesforce commerce
              cloud to shopify migration. Drop your email and we&rsquo;ll send it across.
              We won&rsquo;t follow up unless you ask.
            </p>
          ...
          <div className="w2s-guide-visual">
            ...
            <img
              ...
              alt="Salesforce Commerce Cloud to Shopify migration playbook preview"
              loading="lazy"
            />
          </div>
        </div>
        ...
        <div className="w2s-checkout-inner">
          ...
          <div className="w2s-checkout-copy">
            <h2 className="w2s-checkout-h2">
              Shop Pay does what your custom SFCC checkout never could.
            </h2>
            <p className="w2s-checkout-lead">
              You spent years tuning the cart on Salesforce Commerce Cloud. After the
              salesforce to shopify plus migration you stop maintaining checkout entirely.
              Shop Pay handles one tap conversion across every Shopify Plus store on the
              internet. Your conversion math gets better, not worse.
            </p>
        ...
        <div className="w2s-scalable-inner">
          <div className="w2s-scalable-copy">
            <h2 className="w2s-scalable-h2">
              Shopify Plus is operated infrastructure. Black Friday becomes a non event.
            </h2>
          ...
          <article className="w2s-compare-card w2s-compare-card--full w2s-compare-card--split w2s-compare-card--jessakae">
            ...
            <div className="w2s-compare-split-copy">
              ...
              <p className="w2s-compare-body">
                Most agencies treat a salesforce commerce cloud to shopify migration as a
                clean rebuild. That turns into a year of work and a year of risk. We treat
                it as a port. Same products, same business logic, new storefront. 60 to 90
                days, not 12 months.
              </p>
              <ul className="w2s-compare-features">
                <li>
                  ...
                  <p className="w2s-compare-feat-body">
                    Designers and developers fluent in Shopify Plus, B2B price lists, and the
                    apps your team already runs
                  </p>
                </li>
                <li>
                  <h5 className="w2s-compare-feat-title">Technology Partners</h5>
                  <p className="w2s-compare-feat-body">
                    Integrations built to extend Shopify Plus exactly where SFCC was holding
                    you back
                  </p>
                </li>
                <li>
                  ...
                  <p className="w2s-compare-feat-body">
                    Full service agencies handling creative, paid, and development under one
                    roof
                  </p>
                </li>
              </ul>
          ...
          <div className="w2s-implement-row">
            ...
            <article className="w2s-compare-card w2s-implement-quote-card">
              <blockquote className="w2s-compare-quote w2s-compare-quote--plain">
                <p>
                  &ldquo;The launch engineer was on Slack at 2 AM the night before our SFCC
                  cutover. He didn&rsquo;t just answer questions, he caught two issues we
                  missed. Worth every dollar.&rdquo;
                </p>
        ...
        <div className="w2s-followup-inner">
          <article className="w2s-compare-card w2s-compare-card--full w2s-compare-card--split w2s-compare-card--global">
            <div className="w2s-compare-split-copy">
              ...
              <p className="w2s-compare-body">
                Shopify Plus runs every market, every B2B account, and every social channel
                off the same admin. Instagram, TikTok, eBay, your wholesale portal, all
                pulling from one source of truth. Once we migrate from salesforce to shopify
                plus the dashboard does the work. You sell.
              </p>
            </div>
      ...
      <section className="w2s-process">
        <div className="w2s-process-inner">
          <h2 className="w2s-process-h2">How we actually run a salesforce to shopify migration</h2>
        ...
        <div className="w2s-data-inner">
          <div className="w2s-data-visual">
            ...
            <img
              ...
              alt="Reviewing Salesforce to Shopify migration data on a tablet"
              loading="lazy"
            />
          </div>
          <div className="w2s-data-copy">
            <h2 className="w2s-data-h2">What we actually move when you migrate from salesforce commerce cloud to shopify</h2>
            <p className="w2s-data-lead">
              Products, customers, orders, B2B accounts, price books, content, redirects. All
              of it ends up on Shopify Plus, mapped one for one to your SFCC data model.
              Demandware Site Genesis catalogs, custom ISML templates, OCAPI integrations,
              we&rsquo;ve ported all of them before.
            </p>
      ...
      <section className="w2s-rodeo-section">
        <div className="w2s-rodeo-inner">
          ...
          <p className="w2s-rodeo-lead">
            We&rsquo;ve shipped Shopify Plus stores for D2C, B2B, wholesale, and POS, with site
            speeds up to 150% faster post launch and downtime measured in seconds, not days.
            If you&rsquo;re shopping for a salesforce to shopify migration agency, you&rsquo;re
            looking for a team that&rsquo;s done the work before. The brands paying attention
            are already on Shopify Plus.
          </p>
      ...
      <section className="w2s-partners">
        <div className="w2s-partners-inner">
          ...
          <p className="w2s-partners-lead">
            ...
            you&rsquo;re planning a salesforce to shopify plus migration, we&rsquo;ve already
            shipped stores on the stack you&rsquo;re standing up. Less integration debt, faster
            launch.
          </p>
      ...
      <section className="w2s-customizer">
        <div className="w2s-customizer-inner">
          <h2 className="w2s-customizer-h2">The admin your merchandisers actually wanted. No ISML required.</h2>
          <p className="w2s-customizer-lead">
            A salesforce to shopify migration shouldn&rsquo;t cost your operations team a
            quarter of retraining. Products, content, prices, promotions, all of it lives in
            one Shopify admin they&rsquo;ll learn in an afternoon. Your team owns the
            storefront. Engineering stops being the bottleneck for every banner change.
          </p>
      ...
      {/* FAQ — Salesforce to Shopify migration objections */}
      <section className="w2s-faq">
        <div className="w2s-faq-inner">
          <h2 className="w2s-faq-h2">Salesforce to Shopify Migration FAQs</h2>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .w2s-hero {
          ...
          background-image: url("/images/salesforce-hero.webp");
