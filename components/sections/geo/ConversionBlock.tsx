...
// the button and the form sit in the same block with the "or" line between
// them rather than being scattered up the page.
    ...
    <section id={id} className="gp-section gp-section--cream gcb-section" aria-labelledby={`${id}-heading`}>
      <style
        dangerouslySetInnerHTML={{
          ...
          /* The booking door. The form is the other one, in the column beside
             it. There is deliberately no "or fill in the form" line here any
             more: conversion.whatYouGet now opens by naming both options in
             order, so a second pointer to the form was restating it. */
