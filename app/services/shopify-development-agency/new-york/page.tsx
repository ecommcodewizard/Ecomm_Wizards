...
import { SHOPIFY_DEV_NEW_YORK as page } from "@/lib/geo/pages/shopify-development-agency-new-york";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme page 5 (Batch 1b). Content lives in
// lib/geo/pages/shopify-development-agency-new-york.ts; this route wires
