...
import { SHOPIFY_DEV_SAN_DIEGO as page } from "@/lib/geo/pages/shopify-development-agency-san-diego";
import { canonicalUrl, isRenderable } from "@/lib/geo/registry";
import { og } from "@/lib/og";

// Geo programme page 8 (Batch 1). Content lives in
// lib/geo/pages/shopify-development-agency-san-diego.ts; this route wires
