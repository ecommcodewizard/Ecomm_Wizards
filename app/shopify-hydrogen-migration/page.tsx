...
export const metadata: Metadata = {
  title: "Migrate to Shopify Hydrogen | Headless Storefronts Built by Ecomm Wizards",
  description:
    "We're the agency brands call when they want to migrate to Shopify Hydrogen without losing weeks of trading. Real owner, real engineering team, real launch dates.",
};
...
const HYDROGEN_WHY_ITEMS: HydrogenWhyItem[] = [
  ...
  },
  {
    ...
    body: (<>Tap into the Storefront API for dynamic product recommendations, custom user flows, and robust A/B testing capabilities that can drive <strong>15-20% increases in sales</strong> (according to Forrester Research).</>),
  },
  {
    title: "Seamless SEO & Headless CMS Integrations",
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              Migrate to Shopify Hydrogen without losing a week of trading.
            </h1>
          ...
          <div className="w2s-hero-visual">
            ...
            <img
              ...
              alt="Legacy storefront transitioning to a Shopify Hydrogen analytics dashboard"
              width={1024}
              height={1024}
              loading="eager"
            />
