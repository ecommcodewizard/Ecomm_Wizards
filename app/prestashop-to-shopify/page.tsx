...
export const metadata: Metadata = {
  title: "Migrate PrestaShop to Shopify | Top Agency for PrestaShop to Shopify Plus Migration",
  description:
    "We're the agency PrestaShop merchants call when they want their products, customers, orders, and redirects moved to Shopify cleanly. Talk to the owner first, see the work before you commit a cent.",
};
        ...
        <div className="w2s-hero-inner">
          <div className="w2s-hero-copy">
            <h1 className="w2s-hero-h1">
              Look, migrating PrestaShop to Shopify is messy. We&rsquo;ll do it for you, cleanly.
            </h1>
          ...
          <div className="w2s-hero-visual">
            ...
            <img
              ...
              alt="PrestaShop store transitioning to Shopify analytics dashboard"
              width={1024}
              height={1024}
              loading="eager"
            />
